...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name infra-provider-gcp-builder
	$(CONTAINER_TOOL) buildx use infra-provider-gcp-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm infra-provider-gcp-builder
	rm Dockerfile.cross
